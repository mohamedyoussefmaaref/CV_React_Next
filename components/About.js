            ...
            <section className="hero wrapper has-text-centered">
                ...
                <div className="columns is-mobile">
                    <div className="column has-text-right-tablet has-text-center is-12-mobile is-6-desktop">
                        <dl>
                            <dt>FULL NAME</dt>
                            <dd>Mohamed Youssef Maaref</dd>
                            <dt>EMAIL</dt>
                            <dd>mohamed.youssef.maaref@gmail.com</dd>
                            <dt>MOBILE NO.</dt>
                            <dd>(+216)93858124</dd>
                        </dl>
                    </div>
                    <div className="column has-text-left">
                        <img src="/static/images/profil.jpg" className="mascot" />
                    </div>
                </div>
                <div className="columns">
                    <div className="column detail is-10 is-offset-1 is-6-desktop is-offset-3-desktop is-10-mobile is-offset-1-mobile">
                        Hello, my name is <b>Mohamed Youssef Maaref</b>. 
                        Now, I work as a Business Analyst at Vermeg.
